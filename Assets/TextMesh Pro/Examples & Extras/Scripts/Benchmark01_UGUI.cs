...
namespace TMPro.Examples
{
    ...
    public class Benchmark01UGUI : MonoBehaviour
    {
        ...
        IEnumerator Start()
        {
            ...
            {
                mTextMeshPro = gameObject.AddComponent<TextMeshProUGUI>();
                ...
                mMaterial02 = Resources.Load<Material>("Fonts & Materials/LiberationSans SDF - BEVEL"); // Make sure the LiberationSans SDF exists before calling this...  


            }
            else if (benchmarkType == 1) // TextMesh
            {
                mTextMesh = gameObject.AddComponent<Text>();
                ...
                mTextMesh.alignment = TextAnchor.MiddleCenter;
            ...
            for (int i = 0; i <= 1000000; i++)
            {
                if (benchmarkType == 0)
                {
                    mTextMeshPro.text = LABEL01 + (i % 1000);
                    if (i % 1000 == 999)
